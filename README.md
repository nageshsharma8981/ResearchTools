...
| AI PLS | `pls-sem.html` | SmartPLS-style PLS-SEM with AI interpretation, fully in-browser: TAM template + auto-build from column prefixes, drag-and-drop item assignment, α/ρA/CR/AVE, outer weights, cross-loadings, Fornell–Larcker, HTMT, 5,000-resample bootstrap (custom 100–10,000), total effects, f²/VIF/R², draggable path diagram, APA write-up. Keyless; data never leaves the device. |
